...
export const handler = async (event) => {
  try {
    for (const record of event.Records) {
      ...
      try {
        var bucketName = 'catalog-marketplace-anotaai-challenge';
        ...
        if (body.type === 'delete-product') {
          deleteItem(catalogData.products, body.productId);
        }
        if (body.type === 'delete-category') {
          deleteItem(catalogData.categories, body.categoryId);
        }
...
function deleteItem(catalog, id) {
